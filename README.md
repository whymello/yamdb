...
Реализована базовая инфраструктура API и основные доменные сущности:
...
* ресурсы:
  ...
  * жанры
  * произведения
* реализована модель отзывов
* настроены права доступа и пагинация

Реализация логики отзывов и комментариев к отзывам находится в разработке.
...
* Реализована модель `Review`, которая содержит:
...
API для управления отзывами находится в разработке.
